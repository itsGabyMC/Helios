...
function showFatalStartupError(){
    setTimeout(() => {
        $('#loadingContainer').fadeOut(250, () => {
            ...
            setOverlayContent(
                'Erreur fatale ! Impossible de chercher le fichier de distribution',
                'Une connexion n\'a pas pu être établie avec nos serveurs pour télécharger le fichier de distribution. Aucune copie locale n\'était disponible pour le chargement. <br> <br> Le fichier de distribution est un fichier essentiel qui fournit les dernières informations sur le serveur. Le lanceur ne peut pas démarrer sans lui. Assurez-vous que vous êtes connecté à Internet et relancez l\'application.',
                'Fermer'
            )
            setOverlayHandler(() => {
