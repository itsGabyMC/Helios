...
remote.getCurrentWebContents().on('devtools-opened', () => {
    console.log('%cLa console est sombre et pleine d\'horreur.', 'color: white; -webkit-text-stroke: 4px #a02d2a; font-size: 60px; font-weight: bold')
        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/superkooka/Oerthyon/releases/download/v${info.version}/oerthyon-${info.version}.dmg`
                    showUpdateUI(info)
                }
...
document.addEventListener('readystatechange', function () {
    if (document.readyState === 'interactive'){
        loggerUICore.log('Chargement du UICore..')
