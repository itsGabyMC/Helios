    ...
    if(selectedAcc != null){
        ...
        if(!val){
            ...
            setOverlayContent(
                ...
                `Nous n'avons pas pu actualiser la connexion pour <strong>${selectedAcc.displayName}</strong>. Veuillez ${accLen > 0 ? 'sélectionnez un autre compte ou ' : ''} vous reconnecter à nouveau.`,
                'Se reconnecter',
